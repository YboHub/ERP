...
<html>
  ...
  $(function(){
	  ...
	  $('#dg').datagrid({    
		    url:'inventory/datagrid?warehousenum='+warehousenum,
		    fitColumns:true, 
		    singleSelect:true, 
		    toolbar: '#addTool',
		    rownumbers:true,
		    ...
		    columns:[[    
		        ...
		        {field:'rtime',title:'入库时间',width:100,
  ...
  <body>
	...
	<div data-options="name:'goodstype',iconCls:'icon-ok'">货物类型</div> 
	</div> 
	<a id="btn" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" onclick="clearFun()">清空</a>  </br>
  	<table id="dg"></table>
