...
<html>
  <head>
    ...
    <title>My JSP 'ischeck.jsp' starting page</title>
  ...
  <body>
	...
	<!-- <div data-options="name:'caozuoname'">查询质检人</div>  -->
	</div> 
