...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
  ...
  <div id="addToolsone"  data-options="region:'center'">  
	...
	<form  id="myForm">
		 ...
		 <input value="20" name="states" type="hidden"/>
	  	 <table id="purdetail" class="purdetail" border="1">
	  		<tr>
	  			...
	  			<th width="100px" class="tdColor"style="text-align:center">备注</th>
	  			...
	  			<c:forEach items="${purList}" var="obj" varStatus="stat">
					<tr>
		  				...
		  				<td style="text-align:center">${obj.reason}</td>
		  				<td>
		  					<input type='button' onclick="delONeReturn(${obj.id})" class='btn btn-danger radius' value='退货'>
		  				</td>
	  				</tr>
	  			</c:forEach>
	  	 </table>
   ...
   function addOne(){
 	 i++;
   	$("#purdetail").append("<tr>"
        	...
        	+" <td><input id='reason"+i+"' name='reason' required='true' value='' /></td>"
